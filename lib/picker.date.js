...
DatePicker.prototype.nodes = function( isOpen ) {
    ...
    var
        ...
        // Create week column title node.
        firstItemWeekTitle = function () {
            return [
                settings.week,
        ...
        // Create week number node from a day.
        firstItemWeekNumber = function (day) {
            var firstJan, weekNumber, targetDate;

            targetDate = calendar.create([viewsetObject.year, viewsetObject.month, day + (settings.firstDay ? 1 : 0)]);
            ...
            return _.node(
                ...
                _.node(
                    ...
                    _.group({
                        ...
                        i: 1,
                        node: 'th',
                        firstItem : settings.showWeekNumber ? firstItemWeekTitle : false,
                ...
                item: function( rowCounter ) {
                    ...
                    return [
                        _.group({
                            ...
                            i: 1,
                            node: 'td',
                            firstItem : settings.showWeekNumber ? firstItemWeekNumber : false,
